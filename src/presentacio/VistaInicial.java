...
public class VistaInicial {
	...
	private void ini() {
		...
		panelInici.setBackground(new Color(255, 255, 255));
		panelInici.setBorder(BorderFactory.createLineBorder(new Color(0, 0, 0)));
        panelInici.setForeground(new Color(255, 255, 255));
