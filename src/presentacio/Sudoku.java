...
public class Sudoku extends JFrame  implements ActionListener, KeyListener, PropertyChangeListener, MouseListener, ItemListener, ListSelectionListener {
	...
	Color[][] testColor = {{new Color(240,240,240),Color.YELLOW, Color.GREEN, Color.CYAN},
												{new Color(240, 240, 240), Color.CYAN, new Color(240, 240, 240), new Color(240, 240, 240)},
												{Color.YELLOW, Color.GREEN, Color.CYAN, new Color(240, 240, 240)},
												{Color.CYAN, new Color(240, 240, 240), new Color(240, 240, 240), new Color(240, 240, 240)}};
